...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double kHighSpeedMetersPerSecond = 4.75; 
    public static final double kLowSpeedMetersPerSecond = 3.0;
    public static final double kMinSpeedMetersPerSecond = 0.05;
    ...
    public static final double kTrackWidth = Units.inchesToMeters(25.5); // 0.652;
    // Distance between centers of right and left wheels on robot
    public static final double kWheelBase = Units.inchesToMeters(25.5); // 0.65;
    // Distance between front and back wheels on robot
    public static final double kDriveBaseRadius = Units.inchesToMeters(18.03);
    ...
    public static final HolonomicPathFollowerConfig autoConfig = new HolonomicPathFollowerConfig(
      new PIDConstants(1.0,0.0,0.0), //TODO set gains correctly
      new PIDConstants(1.0, 0.0, 0.0), 
      kLowSpeedMetersPerSecond,
      kDriveBaseRadius,
  ...
  public static final class Utility {
    ...
    public static final int kRightShooter = 2;
    public static final int kLeftShooter = 4;
    public static final int kRightIntake = 3;
    public static final int kLeftIntake = 5;
    ...
    public static final IdleMode shootingMotorIdleMode = IdleMode.kCoast;
    public static final IdleMode intakeMotorIdleMode = IdleMode.kBrake;
    public static final IdleMode climberMotorIdleMode = IdleMode.kBrake;
  }
}
